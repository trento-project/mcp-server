...
For the complete reference, including command-line flags and detailed examples, see the xref:../Trento MCP Server documentation/configuration-options.adoc[Configuration Options] page.
====
...
|`STATELESS`
|`false`
|Enable MCP protocol 2026-07-28 stateless mode. Cannot be combined with `TRANSPORT=sse`. See
