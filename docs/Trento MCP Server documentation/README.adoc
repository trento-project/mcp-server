...
|link:./integration-mcp-clients.adoc[Integrating the Trento MCP Server with MCP Clients] |Information on how to configure and use the Trento MCP Server with MCP clients like VS Code, Claude Desktop, and others
