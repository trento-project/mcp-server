...
* **A running Trento Server** (version 3.x or later) - Check out the link:https://documentation.suse.com/sles-sap/trento/html/SLES-SAP-trento/sec-trento-installing-trentoserver.html[official documentation] for installation guidance.
