...
. `make run`
. Install link:https://code.visualstudio.com/download[VS Code] and the link:vscode:extension/GitHub.copilot[Copilot extension] (see xref:Trento MCP Serve documentation/README.adoc[other alternatives here])
